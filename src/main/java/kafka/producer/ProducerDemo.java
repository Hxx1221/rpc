...
public class ProducerDemo {
    ...
    private final static String topic = "topic-hxx";

    public static void main(String[] args) throws ExecutionException, InterruptedException {

        Properties properties = new Properties();
        properties.setProperty("bootstrap.servers", "106.12.29.156:9092,106.12.33.235:9092,106.12.14.189:9092");
  ...
  //      properties.put("min.insync.replicas", 3000);
       ...
       // properties.put(ProducerConfig.INTERCEPTOR_CLASSES_CONFIG, strings);
        ...
        for (int i = 0; i < 100; i++) {
            ...
            stringStringKafkaProducer.send(new ProducerRecord<String, User>(topic, "" + i, user), new Callback() {
                @Override
